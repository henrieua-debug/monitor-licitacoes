# Perfil — quem eu sou e o que importa

> Este arquivo é a memória de contexto do Chief of Staff. Edite livremente.
...
- **Equiplano** (govtech / gestão pública municipal)
- **IDS**
- **Useall** (ERP / gestão)

> Para cada uma, preencha com o tempo: nome do CEO/líder que reporta, cadência de
> reporte (mensal? trimestral?), e quais números você cobra (receita, EBITDA,
> churn, pipeline, etc.).

| Empresa            | Líder que reporta | Cadência do reporte | O que eu cobro |
|--------------------|-------------------|---------------------|----------------|
| Governança Brasil  | _(preencher)_     | _(preencher)_       | _(preencher)_  |
| Equiplano          | _(preencher)_     | _(preencher)_       | _(preencher)_  |
| IDS                | _(preencher)_     | _(preencher)_       | _(preencher)_  |
...
controle de pendências em duas direções:
1. **Eu estou esperando** — reporte de empresa que não chegou, pergunta que fiz e
   não foi respondida, compromisso que alguém assumiu e ainda não entregou.
2. **Eu devo resposta** — e-mail de VIP (sobretudo Puneet) parado na minha caixa,
   decisão que travou esperando por mim.
...
- Prefiro **ação concreta** a resumo genérico. "Cobrar o reporte de julho da
  Equiplano com o João" vale mais que "há pendências no pipeline".
- Idioma: **português** (termos técnicos de negócio em inglês quando for natural).
